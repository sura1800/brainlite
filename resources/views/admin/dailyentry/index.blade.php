                                        ...
                                        <select class="form-control" id="user_id" name="user_id">
                                            ...
                                            @foreach($customers as $customer)
                                               <option value="{{$customer->id}}"
                                                @php
                                                    if(isset($_GET['user_id']) && $_GET['user_id'] == $customer->id ){echo 'selected'; }
                                                @endphp >
                                    ...
                                    @if(count($entries) > 0)
                                        @foreach($entries as $key=>$entry)
                                                <tr>
                                                    ...
                                                    <td>
                                                         <a href="{{route('admin.daily-entries.show',$entry)}}"><button type="button" class="btn btn-warning m-1"><i class="nav-icon fas fa-eye"></i></button></a>
                                                    </td>
                                                </tr>
                                        @endforeach
...
<script>
    ...
    $(".reset").click(function(){
        window.location.href = "{{route('admin.daily-entries.index')}}";
    })
</script>
